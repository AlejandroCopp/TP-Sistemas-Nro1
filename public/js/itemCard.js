 ...
 * @param {string} itemData.category - The category of the match (e.g., 'jugadores').
 * @param {string} itemData.location - The location of the match.
 * @param {string} itemData.playerCount - The current number of players vs the max.
 * @param {string} itemData.title - The title of the match.
 * @param {string} itemData.matchType - The type of match (e.g., '5 vs 5').
 * @param {string} itemData.dateTime - The date and time of the match.
 * @param {string} itemData.status - The status of the match (e.g., 'abierto', 'jugando').
 * @param {string} itemData.imageUrl - The URL for the match image.
 * @returns {string} The HTML string for the item card.
 */
export function createItemCard(itemData) {
